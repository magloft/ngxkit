...
import { ApplicationRef, APP_INITIALIZER, InjectionToken, Injector, ModuleWithProviders, NgModule, NgZone, PLATFORM_ID } from '@angular/core'
...
export interface RequestSubscriptionOptions {
...
export const WEB_PUSH_ID = new InjectionToken<string>('WEB_PUSH_ID')

export function ngswAppInitializer(injector: Injector, script: string, options: SwRegistrationOptions, platformId: string): Function {
  const initializer = () => {
